...
class List:
    ...
    def __getitem__(self, i):
        ...
        """
        if i < 0:
            adjusted_index = len(self._values) + i
            assert 0 <= adjusted_index < len(
                self._values), 'Invalid index value'
            value = deepcopy(self._values[adjusted_index])
        else:
            assert 0 <= i < len(self._values), 'Invalid index value'
    ...
    def __setitem__(self, i, value):
        ...
        if i < 0:
            ...
            assert 0 <= adjusted_index < len(
                self._values), 'Invalid index value'
            self._values[adjusted_index] = value
        else:
            assert 0 <= i < len(self._values), 'Invalid index value'
